"""
Test script to generate a 60-second educational video about planets and outer space.
Uses the full pipeline with Enhanced TTS (ElevenLabs + Edge-TTS fallback).
"""
import asyncio
import sys
...
async def main():
    print(Fore.WHITE + "="*70)
    print(Fore.WHITE + "🚀 EDUCATIONAL VIDEO PIPELINE TEST - OUTER SPACE")
    print(Fore.WHITE + "="*70)
    ...
    print(Fore.CYAN + f"🗣️  Audio: Arabic (ElevenLabs + Edge-TTS fallback)")
    print(Fore.CYAN + f"🎨 Visuals: English (Manim animations + Real images)")
