...
export default function VisualTimeStrip({ initialMinutes = 20 }) {
  ...
  // Dynamic margin-top logic
  const isDashboard = location.pathname === "/dashboard/student" || location.pathname === "/dashboard/student/";
  const dynamicMarginTop = isDashboard ? "60px" : "15px";

  const presetOptions = [10, 15, 20, 30, 45, 60];

  return (
    <>
      <div className="visual-time-strip-container" style={{ marginTop: dynamicMarginTop }}>
